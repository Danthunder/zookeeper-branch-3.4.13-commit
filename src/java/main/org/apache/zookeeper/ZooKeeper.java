...
public class ZooKeeper {
        ...
        throws IOException
    {
        ...
        /**
         * getClientCnxnSocket()返回 NIO socket实例
         * 初始化zookeeper
         *  1. 初始化ClientCnxn（client上下文环境）
         *  2. 创建两个线程 SendThread 和 EventThread
         *  3. 启动SendThread和EventThread线程
         *  4. SendThread线程负责建立socket连接（NIO）
         */

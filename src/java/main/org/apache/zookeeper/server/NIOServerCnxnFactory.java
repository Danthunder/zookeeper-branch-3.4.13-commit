...
public class NIOServerCnxnFactory extends ServerCnxnFactory implements Runnable {
    ...
    */
    ...
    public void configure(InetSocketAddress addr, int maxcc) throws IOException {
        ...
        // 如果不设置次属性，默认为用户线程。
        // 守护进程（Daemon）是运行在后台的一种特殊进程。它独立于控制终端并且周期性地执行某种任务或等
        // 待处理某些发生的事件。也就是说守护线程不依赖于终端，但是依赖于系统，与系统“同生共死”。
        // 那Java的守护线程是什么样子的呢。当JVM中所有的线程都是守护线程的时候，JVM就可以退出了；如果
        // 还有一个或以上的非守护线程则JVM不会退出
        ...
        this.ss = ServerSocketChannel.open(); // 打开channel，接收客户端发来的请求
